...
import loginShuffle.ScoreShuffle;
import loginShuffle.ScoreShuffleMapper;
import loginShuffle.ScoreShuffleReducer;

public class ScoreShuffle {
	...
	public static class loginCount {
		public static void main(String[] args) throws Exception{
			...
			// TODO Auto-generated method stub
					...
					loginCount.setMapperClass(ScoreShuffleMapper.class);
					//设置wordCountJob所用的reducer逻辑类为哪个类
					loginCount.setReducerClass(ScoreShuffleReducer.class);
					
					//设置map阶段输出的kv数据类型
					loginCount.setMapOutputKeyClass(DoubleWritable.class);
